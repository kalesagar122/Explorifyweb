...
namespace Explorify.Web.Controllers
{
    ...
    public class UsersAdminController : Controller
    {
        ...
        public async Task<ActionResult> Details(string id)
        {
            ...
            var userd = ConvertDataTable<UserDetailModel>(GetUserDetail(id)).FirstOrDefault<UserDetailModel>();
        ...
        private static DataTable GetUserDetail(string id)
        {
            var dt = new DataTable();
            var parameter1 = new SqlParameter("@UserId", id);
            ...
            using (var conn = new SqlConnection(ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString))
            {
                ...
                {
                    cmd.CommandText = "SpGetUserDetail";
